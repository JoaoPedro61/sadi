...
mod tests {
    ...
    fn test_transient_factory_creates_new_instances() {
        ...
        let first = (provider.factory)(&injector);
    ...
    fn test_transient_factory_with_different_types() {
        ...
        let first_string = (string_provider.factory)(&injector);
        let second_string = (string_provider.factory)(&injector);
        ...
        let first_vec = (vec_provider.factory)(&injector);
